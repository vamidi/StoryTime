...
@Component({
	selector: 'ngx-insert-equipment-dialog',
	templateUrl: './insert-equipment.component.html',
	// styleUrls: ['./insert-trait.component.scss'],
})
export class InsertEquipmentComponent implements OnInit, AfterViewInit, OnDestroy, IBehaviour
{
	@Input()
	...
	public onSendForm()
	{
		...
		if(this.formComponent.isValid)
		{
			...
			switch(this.behaviourType)
			{
				...
				{
					this.saveEvent.emit({
							newData: { typeId: hasItemTypeValue, equipment: hasItemListValue },
